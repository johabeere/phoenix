...
config = picam2.create_video_configuration(main = {'size': tuple(h.parameters['Camera']['resolution'])}, sensor = {'output_size': mode['size'], 'bit_depth': mode['bit_depth']}, controls = {'FrameRate': frame_rate})
...
def start_camera(): 
    ...
    picam2.set_controls({"AfMode": controls.AfModeEnum.Continuous, "AfSpeed": controls.AfSpeedEnum.Fast})  #* This could be moved into the video config. Works either way and i want to go to sleep
